...
const Main = () => {
  ...
  return (
    ...
    <button onClick={nuh_uh} class="grid__item grid__item--moss grid__item--lg grid__item--4">
        <span class="grid__item-door">
            4
        </span>
        <span class="grid__item-shadow"></span>
    </button>
    <button onClick={nuh_uh} class="grid__item grid__item--5">
        <span class="grid__item-door">
            5
        </span>
        <span class="grid__item-shadow"></span>
    </button>
    <button onClick={nuh_uh} class="grid__item grid__item--rose grid__item--lg grid__item--6">
        <span class="grid__item-door">
            6
        </span>
        <span class="grid__item-shadow"></span>
    ...
    <button onClick={nuh_uh} class="grid__item grid__item--10">
        <span class="grid__item-door">
            10
        </span>
        <span class="grid__item-shadow"></span>
    </button>
    <button onClick={nuh_uh} class="grid__item grid__item--sky grid__item--11">
        <span class="grid__item-door">
            11
        </span>
        <span class="grid__item-shadow"></span>
    </button>
    <button onClick={nuh_uh} class="grid__item grid__item--12">
        <span class="grid__item-door">
            12
        </span>
        <span class="grid__item-shadow"></span>
    </button>
    <button onClick={nuh_uh} class="grid__item grid__item--moss grid__item--lg grid__item--13">
        <span class="grid__item-door">
            13
        </span>
        <span class="grid__item-shadow"></span>
    </button>
    <button onClick={nuh_uh} class="grid__item grid__item--14">
        <span class="grid__item-door">
            14
        </span>
        <span class="grid__item-shadow"></span>
